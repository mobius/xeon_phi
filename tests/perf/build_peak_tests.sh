...
echo ""
echo "Or use micnativeloadex:"
echo "  micnativeloadex ./phi_stream_bench.mic"
echo "  micnativeloadex ./phi_peak_fp64.mic"
echo "  micnativeloadex ./phi_peak_fp32.mic"
echo "  micnativeloadex ./phi_peak_dgemm.mic"
